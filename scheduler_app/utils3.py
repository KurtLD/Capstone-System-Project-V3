...
# def generate_scheduleMD(start_date):
#     try:
#         logger.info("Starting schedule generation...")
...
#         # Clear existing schedules
#         ScheduleMD.objects.filter(school_year=current_school_year).delete()
#         logger.debug("Existing schedules cleared.")

#         groups = list(GroupInfoMD.objects.filter(school_year=current_school_year))
#         random.shuffle(groups)
#         logger.debug(f"Fetched {len(groups)} groups for scheduling.")
